...
public class Main extends JFrame {
    ...
    private Main() {
        ...
        lblNewLabel.setIcon(new ImageIcon("./resources/img/title.gif"));
        ...
        btnNewButton.setIcon(new ImageIcon("./resources/img/SinglePlayer.gif"));
        btnNewButton.addActionListener(e -> play(Mode.Single));
        btnNewButton.setBorderPainted(false);
        panel.add(btnNewButton);

        JButton btnNewButton1 = new JButton("");
        btnNewButton1.setBounds(224, 298, 144, 34);
        btnNewButton1.setIcon(new ImageIcon("./resources/img/DoublePlayer.gif"));
        btnNewButton1.setBorderPainted(false);
        btnNewButton1.addActionListener(e -> play(Mode.Double));
