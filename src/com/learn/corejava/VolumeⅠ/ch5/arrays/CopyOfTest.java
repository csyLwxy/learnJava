package com.learn.corejava.VolumeⅠ.ch5.arrays;
...
public class CopyOfTest {
     ...
     * @param newLength the new length* @return a larger array that contains all elements of a. However, the returned array has
