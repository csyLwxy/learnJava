package com.learn.corejava.VolumeⅡ.ch4.post;
...
public class PostTest {
    public static void main(String[] args) throws IOException {
        String propsFilename = args.length > 0 ? args[0] : "src/com/learn/corejava/VolumeⅡ/ch4/post/post.properties";
     ...
     */
    private static String doPost(URL url, Map<Object, Object> nameValuePairs, String userAgent, int redirects)
            throws IOException {
